...
public class ScoreBoardActivity extends Activity {
	...
	public class ServerThread extends AsyncTask<String, Void, ArrayList<String>> {
		@Override
		protected void onPostExecute(ArrayList<String> result) {
			// TODO Auto-generated method stub
			super.onPostExecute(result);
			progressBar.setVisibility(View.GONE);
			listUser.setAdapter(new ArrayAdapter<String>(ScoreBoardActivity.this, R.layout.list_user_item,result));
		}
	...
	public ArrayList<String> parseJSON(String jsonString){
		...
		try {
			...
			for(int i=0; i<jArray.length(); i++){
				...
				listUser.add( (i+1)+". "+jObject.getString("username")+"     "+jObject.getString("score"));
			}
